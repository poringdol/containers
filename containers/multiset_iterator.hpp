...
// Iterator class -------------------------------------------------------------
	...
	public:
		...
		multiset_iterator() throw() : ptr() {}
		multiset_iterator(Node* newptr) throw() : ptr(newptr) {}
...
// Reverse iterator class -------------------------------------------------------------
	  ...
	  template<typename T, typename Node>
	struct multiset_reverse_iterator {
	...
	public:
		...
		typedef multiset_reverse_iterator	reverse_iterator;
		typedef size_t					size_type;
		typedef T						value_type;
		typedef value_type*				pointer;
		typedef const value_type*		const_pointer;
		...
		multiset_reverse_iterator() throw() : ptr(NULL) {}
		multiset_reverse_iterator(Node* newptr) throw() : ptr(newptr) {}
